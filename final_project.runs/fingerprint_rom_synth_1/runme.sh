...
HD_PWD='C:/Users/devin/final_project/final_project.runs/fingerprint_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fingerprint_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fingerprint_rom.tcl
