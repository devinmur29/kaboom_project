...
HD_PWD='C:/Users/devin/final_project/final_project.runs/gcm_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gcm.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gcm.tcl
