...
HD_PWD='C:/Users/devin/final_project/final_project.runs/blue_fing_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blue_fing.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blue_fing.tcl
