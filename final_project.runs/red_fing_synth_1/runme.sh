...
HD_PWD='C:/Users/devin/final_project/final_project.runs/red_fing_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log red_fing.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source red_fing.tcl
