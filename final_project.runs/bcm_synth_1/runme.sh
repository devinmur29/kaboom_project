...
HD_PWD='C:/Users/devin/final_project/final_project.runs/bcm_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bcm.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bcm.tcl
