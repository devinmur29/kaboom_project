...
#
# Generated by export_simulation on Sat Nov 21 16:19:51 -0500 2020
#
################################################################################
...
'-reset_run' switch to the './red_fing.sh' script.

./red_fing.sh -reset_run
...
./red_fing.sh -noclean_files

For more information on the script, please type './red_fing.sh -help'.
