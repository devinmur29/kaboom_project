...
#
# Generated by export_simulation on Wed Nov 18 15:29:05 -0500 2020
#
################################################################################
...
'-reset_run' switch to the './blue_fing.sh' script.

./blue_fing.sh -reset_run
...
./blue_fing.sh -noclean_files

For more information on the script, please type './blue_fing.sh -help'.
