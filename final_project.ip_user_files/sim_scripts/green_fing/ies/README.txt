...
#
# Generated by export_simulation on Sat Nov 21 16:21:47 -0500 2020
#
################################################################################
...
'-reset_run' switch to the './green_fing.sh' script.

./green_fing.sh -reset_run
...
./green_fing.sh -noclean_files

For more information on the script, please type './green_fing.sh -help'.
