...
#
# Generated by export_simulation on Wed Dec 02 10:55:41 -0500 2020
#
################################################################################
...
'-reset_run' switch to the './gcm.sh' script.
...
./gcm.sh -noclean_files

For more information on the script, please type './gcm.sh -help'.
